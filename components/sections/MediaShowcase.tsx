  ...
  return (
    <section className="bg-white w-full">
      <div className="w-full">
        {title?.trim() ? (
          <div className="container mx-auto px-6 sm:px-10 lg:px-16 mb-10">
            ...
            return (
              ...
              >
                {item.imageUrl ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center border border-dashed border-white/40">
