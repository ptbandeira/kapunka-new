    ...
    >
      ...
      <div className="mt-4">
        ...
        <div className="flex items-center justify-between mt-4">
          <p className="text-xl font-bold text-stone-900" data-nlv-field-path={`${fieldPath ?? baseFieldPath}.price`}>
          ...
          >
            <span data-nlv-field-path={`translations.${language}.academy.enrollNow`}>
              {t('academy.enrollNow')}
            </span>
          </a>
        </div>
